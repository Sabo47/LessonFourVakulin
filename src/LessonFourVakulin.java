    ...
    class PhoneBook<T extends PhoneRecord> extends ArrayList {
        // Класс телефонной книги, хранящий записи и наследованный от ArrayList и есть коллекция
    ...
    public class LessonFourVakulin {
        ...
        public static void main(String[] args) {
            ...
            pb.add("Матроскин","84262260011");
            pb.add("Шариков","84262220011");
            pb.add("Чугункин","84262260022");
            pb.add("Сидоров","84262260023");
            System.out.println("Телефонная книга : "+pb);                       // вся телефонная книга
            System.out.println("Совпадения для «Матроскин» : "+pb.get("Матроскин"));  // найденные Ивановы
